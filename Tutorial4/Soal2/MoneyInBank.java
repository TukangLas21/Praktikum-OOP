public class MoneyInBank implements MoneyTransaction{
    ...
    public MoneyTransaction add(MoneyTransaction money) {
        ...
        MoneyInBank result = new MoneyInBank(newAmount, this.interestRate, this.totalLoanAmount);
        return result;
    }
    ...
    public int calcInterest() {
        return (int) (this.amount * this.interestRate) / 100;
    }
    ...
    public void borrow(int loanAmount) {
        ...
        this.totalLoanAmount += (int) (loanAmount * (100 + interestRate)) / 100;
    }
